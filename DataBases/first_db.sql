...
-- -----------------------------------------------------
-- Table `school`.`instractors`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `school`.`instractors` (
  `instractor_id` SMALLINT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `school`.`courses` (
  ...
  `price` INT NOT NULL,
  `instractor_id` SMALLINT NOT NULL,
  PRIMARY KEY (`course_id`),
  INDEX `fk_courses_instractors1_idx` (`instractor_id` ASC) VISIBLE,
  CONSTRAINT `fk_courses_instractors1`
